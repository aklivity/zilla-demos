...
import AppLoader from '@/app-loader'
import VehicleLocationPlugin from '@/plugins/vehicle-location/vehicle-location-plugin.js'
...
appHooks.add('appLoaded', (vueInstance) => {
  const plugin = new VehicleLocationPlugin(vueInstance)
  appHooks.attachPlugin(plugin, vueInstance)
  // Do something when the app is loaded
})
